...
(function (App) {
    ...
    var testHandlers = {
        viewbox: {
            ...
            render: function() {
                return (
                    React.createElement(Xaml.Viewbox, null, 
                        React.createElement(Xaml.StackPanel, {horizontalAlignment: "Stretch", verticalAlignment: "Stretch"}, 
                            React.createElement(Xaml.CalendarView, {name: "vc1", minDate: "6/5/2015", maxDate: "6/7/2015"}), 
                            React.createElement(Xaml.CalendarDatePicker, {name: "vc2", date: "6/5/2015"})
                        )
                    )
                );
            }
