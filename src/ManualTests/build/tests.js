...
(function (App) {
    ...
    function renderResults() {
        ...
        var lastTest = "";
        var testIndex = -1;
        return (React.createElement(Xaml.ScrollViewer, null, React.createElement(Xaml.StackPanel, null, Array.prototype.map.call(logs, function (entry, index) {
            if (lastTest !== entry.test) {
                testIndex++;
            }
            lastTest = entry.test;
