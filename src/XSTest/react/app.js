...
(function (App) {
    ...
    function renderImage(image, index) {
        return (React.createElement(Xaml.Grid, {"map$location": image.geoposition, "background": image.color}, React.createElement(Xaml.TextBlock, {"text": 'IMG#' + index})));
    }
    ...
    function renderClusterDebug() {
        ...
        var clusters2 = DimasKmeans.getClusters(data, {
            vectorFunction: function (d) { return d.d; }
        });
        var clusters = clusters1;
        return (React.createElement(Xaml.StackPanel, null, clusters.map(function (i) { return React.createElement(Xaml.TextBlock, {"text": JSON.stringify(i)}); })));
    }
    function renderClusterMap() {
        ...
        return (React.createElement(Xaml.Grid, {"rows": ["*", "auto"]}, React.createElement(Xaml.MapControl, {"zoomLevel": host.getState().zoomLevel, "center": host.getState().centerPoint, "mapServiceToken": key, "onCenterChanged": centerChanged}, React.createElement(Xaml.MapItemsControl, {"items": clusters1.map(function (c, index) { return renderCluster(c, index); })})), React.createElement(Xaml.TextBlock, {"fontSize": 18, "grid$row": 1, "text": host.getState().center})));
    }
    function renderMap() {
        return (React.createElement(Xaml.Grid, {"rows": ["*", "auto"]}, React.createElement(Xaml.MapControl, {"zoomLevel": host.getState().zoomLevel, "center": host.getState().centerPoint, "mapServiceToken": key, "onCenterChanged": centerChanged}, React.createElement(Xaml.MapItemsControl, {"items": host.getState().random_photo_data.map(function (photo, index) { return renderImage(photo, index); })})), React.createElement(Xaml.TextBlock, {"fontSize": 18, "grid$row": 1, "text": host.getState().center})));
    }
})(App || (App = {}));
var DimasKmeans;
